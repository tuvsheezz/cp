...
struct LazySegmentTree
{
  ...
  T __initFun(T a, T b) { return max(a, b); }
  T __getFun(T a, T b) { return max(a, b); }
...
int main()
{
  int n, Q, com, l, r, x;
  cin >> n >> Q;
  LazySegmentTree<long long> lst(n, vector<long long>(n, 0), true, 0);
  while (Q--)
  {
    cin >> l >> r;
    l--, r--;
    long long hei = lst.get(l, r) + 1;
    lst.update(l, r, hei);
    cout << hei << endl;
  }
  return 0;
